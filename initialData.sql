...
--play data
COPY play_info (game_id, team_id, play_type_id, player_id, points, home_score, away_score, play_length, total_game_time) FROM '/Users/whitney/hr/thesis/data/play_info.csv' WITH (FORMAT csv);